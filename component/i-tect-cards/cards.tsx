export function Card({source, title, describtion}){
    return(
        // <div classNameName="bg-red-400">
        //     <h2>Title</h2>
        //     <p>Description</p>
        //     <Profile source={"/images (1).jpeg"} alt={"profile"}/>
        //     <Profile source={"/images.jpeg"} alt={"profile main"}/>
        // </div>
...
<div className="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
    ...
    <p className="mb-6 text-body">{describtion}</p>
...
//             {/* <img src="/public/images.jpeg" alt="profile" /> */}
